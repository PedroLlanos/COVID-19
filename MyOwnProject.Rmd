...
covid_data %>% group_by(date, location) %>%
  filter(date >= t0, location == TCTD[1] | location == TCTD[2] | location == TCTD[3] | location == TCTD[4] | location == TCTD[5] | location == TCTD[6] | location == TCTD[7] | location == TCTD[8] | location == TCTD[9] | location == TCTD[10]) %>%  
  group_by(location) %>% 
